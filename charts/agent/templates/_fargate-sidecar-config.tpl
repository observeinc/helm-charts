...
{{- define "observe.sidecar.FargateSidecar.config.filelog.multiline" -}}
multiline:
  {{- toYaml .Values.nodeless.logs.multiline | nindent 2 }}
{{- end }}
...
{{- if .Values.nodeless.logs.enabled }}
  filelog/fargate-container-logs:
    ...
    {{- if .Values.nodeless.logs.multiline }}
    {{- include "observe.sidecar.FargateSidecar.config.filelog.multiline" . | nindent 4 }}
    {{ end }}
{{ end }}
