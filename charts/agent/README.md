...
| cluster-events.extraEnvs[4].name | string | `"DEPLOYMENT_INSTANCE_NAME"` |  |
| cluster-events.extraEnvs[4].valueFrom.fieldRef.fieldPath | string | `"metadata.labels['app.kubernetes.io/instance']"` |  |
| cluster-events.extraEnvs[5].name | string | `"OBSERVE_AGENT_INSTANCE_ID"` |  |
| cluster-events.extraEnvs[5].value | string | `"$(DEPLOYMENT_INSTANCE_NAME)-cluster-events"` |  |
...
| cluster-metrics.extraEnvs[4].name | string | `"DEPLOYMENT_INSTANCE_NAME"` |  |
| cluster-metrics.extraEnvs[4].valueFrom.fieldRef.fieldPath | string | `"metadata.labels['app.kubernetes.io/instance']"` |  |
| cluster-metrics.extraEnvs[5].name | string | `"OBSERVE_AGENT_INSTANCE_ID"` |  |
| cluster-metrics.extraEnvs[5].value | string | `"$(DEPLOYMENT_INSTANCE_NAME)-cluster-metrics"` |  |
...
| monitor.extraEnvs[4].name | string | `"DEPLOYMENT_INSTANCE_NAME"` |  |
| monitor.extraEnvs[4].valueFrom.fieldRef.fieldPath | string | `"metadata.labels['app.kubernetes.io/instance']"` |  |
| monitor.extraEnvs[5].name | string | `"OBSERVE_AGENT_INSTANCE_ID"` |  |
| monitor.extraEnvs[5].value | string | `"$(DEPLOYMENT_INSTANCE_NAME)-monitor"` |  |
...
| prometheus-scraper.extraEnvs[4].name | string | `"DEPLOYMENT_INSTANCE_NAME"` |  |
| prometheus-scraper.extraEnvs[4].valueFrom.fieldRef.fieldPath | string | `"metadata.labels['app.kubernetes.io/instance']"` |  |
| prometheus-scraper.extraEnvs[5].name | string | `"OBSERVE_AGENT_INSTANCE_ID"` |  |
| prometheus-scraper.extraEnvs[5].value | string | `"$(DEPLOYMENT_INSTANCE_NAME)-prometheus-scraper"` |  |
