...
| cluster-events.extraEnvs[4].name | string | `"DEPLOYMENT_NAME_RELEASE"` |  |
...
| cluster-events.extraEnvs[6].value | string | `"$(DEPLOYMENT_NAME_RELEASE)-$(DEPLOYMENT_NAME_CHART)"` |  |
...
| cluster-metrics.extraEnvs[4].name | string | `"DEPLOYMENT_NAME_RELEASE"` |  |
...
| cluster-metrics.extraEnvs[6].value | string | `"$(DEPLOYMENT_NAME_RELEASE)-$(DEPLOYMENT_NAME_CHART)"` |  |
...
| monitor.extraEnvs[4].name | string | `"DEPLOYMENT_NAME_RELEASE"` |  |
...
| monitor.extraEnvs[6].value | string | `"$(DEPLOYMENT_NAME_RELEASE)-$(DEPLOYMENT_NAME_CHART)"` |  |
...
| prometheus-scraper.extraEnvs[4].name | string | `"DEPLOYMENT_NAME_RELEASE"` |  |
...
| prometheus-scraper.extraEnvs[6].value | string | `"$(DEPLOYMENT_NAME_RELEASE)-$(DEPLOYMENT_NAME_CHART)"` |  |
