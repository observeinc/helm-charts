...
|------------|------|---------|
| https://open-telemetry.github.io/opentelemetry-helm-charts | cluster-events(opentelemetry-collector) | 0.147.1 |
| https://open-telemetry.github.io/opentelemetry-helm-charts | cluster-metrics(opentelemetry-collector) | 0.147.1 |
| https://open-telemetry.github.io/opentelemetry-helm-charts | prometheus-scraper(opentelemetry-collector) | 0.147.1 |
| https://open-telemetry.github.io/opentelemetry-helm-charts | node-logs-metrics(opentelemetry-collector) | 0.147.1 |
| https://open-telemetry.github.io/opentelemetry-helm-charts | monitor(opentelemetry-collector) | 0.147.1 |
| https://open-telemetry.github.io/opentelemetry-helm-charts | forwarder(opentelemetry-collector) | 0.147.1 |
| https://open-telemetry.github.io/opentelemetry-helm-charts | gateway(opentelemetry-collector) | 0.147.1 |
...
| cluster-events.initContainers[0].image | string | `"observeinc/kube-cluster-info:v0.11.8"` |  |
...
| cluster-metrics.initContainers[0].image | string | `"observeinc/kube-cluster-info:v0.11.8"` |  |
...
| forwarder.initContainers[0].image | string | `"observeinc/kube-cluster-info:v0.11.8"` |  |
...
| gateway.initContainers[0].image | string | `"observeinc/kube-cluster-info:v0.11.8"` |  |
...
| monitor.initContainers[0].image | string | `"observeinc/kube-cluster-info:v0.11.8"` |  |
...
| node-logs-metrics.initContainers[0].image | string | `"observeinc/kube-cluster-info:v0.11.8"` |  |
...
| prometheus-scraper.initContainers[0].image | string | `"observeinc/kube-cluster-info:v0.11.8"` |  |
