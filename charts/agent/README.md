...
![Version: 0.85.1](https://img.shields.io/badge/Version-0.85.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.14.0](https://img.shields.io/badge/AppVersion-2.14.0-informational?style=flat-square)
...
| cluster-events.image | object | `{"pullPolicy":"IfNotPresent","repository":"observeinc/observe-agent","tag":"2.14.0"}` | --------------------------------------- # Same for each deployment/daemonset      # |
...
| cluster-metrics.image | object | `{"pullPolicy":"IfNotPresent","repository":"observeinc/observe-agent","tag":"2.14.0"}` | --------------------------------------- # Same for each deployment/daemonset      # |
...
| forwarder.extraEnvs[2].name | string | `"OTEL_K8S_NAMESPACE_NAME"` |  |
| forwarder.extraEnvs[2].valueFrom.fieldRef.fieldPath | string | `"metadata.namespace"` |  |
| forwarder.extraEnvs[3].name | string | `"OTEL_K8S_DEPLOYMENT_ENVIRONMENT_NAME"` |  |
| forwarder.extraEnvs[3].valueFrom.fieldRef.fieldPath | string | `"metadata.annotations['resource.opentelemetry.io/deployment.environment.name']"` |  |
| forwarder.extraEnvs[4].name | string | `"OBSERVE_CLUSTER_NAME"` |  |
| forwarder.extraEnvs[4].valueFrom.configMapKeyRef.key | string | `"name"` |  |
| forwarder.extraEnvs[4].valueFrom.configMapKeyRef.name | string | `"cluster-name"` |  |
| forwarder.extraEnvs[5].name | string | `"OBSERVE_CLUSTER_UID"` |  |
| forwarder.extraEnvs[5].valueFrom.configMapKeyRef.key | string | `"id"` |  |
| forwarder.extraEnvs[5].valueFrom.configMapKeyRef.name | string | `"cluster-info"` |  |
| forwarder.extraEnvs[6].name | string | `"K8S_NODE_NAME"` |  |
| forwarder.extraEnvs[6].valueFrom.fieldRef.fieldPath | string | `"spec.nodeName"` |  |
| forwarder.extraEnvs[7].name | string | `"TOKEN"` |  |
| forwarder.extraEnvs[7].valueFrom.secretKeyRef.key | string | `"OBSERVE_TOKEN"` |  |
...
| forwarder.extraEnvs[8].name | string | `"TRACE_TOKEN"` |  |
| forwarder.extraEnvs[8].valueFrom.secretKeyRef.key | string | `"TRACE_TOKEN"` |  |
| forwarder.extraEnvs[8].valueFrom.secretKeyRef.name | string | `"agent-credentials"` |  |
| forwarder.extraEnvs[8].valueFrom.secretKeyRef.optional | bool | `true` |  |
...
| forwarder.image | object | `{"pullPolicy":"IfNotPresent","repository":"observeinc/observe-agent","tag":"2.14.0"}` | --------------------------------------- # Same for each deployment/daemonset      # |
...
| gateway.image | object | `{"pullPolicy":"IfNotPresent","repository":"observeinc/observe-agent","tag":"2.14.0"}` | --------------------------------------- # Same for each deployment/daemonset      # |
...
| monitor.image | object | `{"pullPolicy":"IfNotPresent","repository":"observeinc/observe-agent","tag":"2.14.0"}` | --------------------------------------- # Same for each deployment/daemonset      # |
...
| node-logs-metrics.image | object | `{"pullPolicy":"IfNotPresent","repository":"observeinc/observe-agent","tag":"2.14.0"}` | --------------------------------------- # Same for each deployment/daemonset      # |
...
| prometheus-scraper.image | object | `{"pullPolicy":"IfNotPresent","repository":"observeinc/observe-agent","tag":"2.14.0"}` | --------------------------------------- # Same for each deployment/daemonset      # |
