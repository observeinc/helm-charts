...
{{ include "kube-events.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kube-events.selectorLabels" -}}
...
*/}}
{{- define "kube-events.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "kube-events.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
...
*/}}
{{- define "kube-events.ingress.apiVersion" -}}
...
*/}}
{{- define "kube-events.ingress.isStable" -}}
  {{- eq (include "kube-events.ingress.apiVersion" .) "networking.k8s.io/v1" -}}
{{- end -}}
{{/*
Return if ingress supports ingressClassName.
*/}}
{{- define "kube-events.ingress.supportsIngressClassName" -}}
  {{- or (eq (include "kube-events.ingress.isStable" .) "true") (and (eq (include "kube-events.ingress.apiVersion" .) "networking.k8s.io/v1beta1") (semverCompare ">= 1.18-0" .Capabilities.KubeVersion.Version)) -}}
{{- end -}}
{{/*
Return if ingress supports pathType.
*/}}
{{- define "kube-events.ingress.supportsPathType" -}}
  {{- or (eq (include "kube-events.ingress.isStable" .) "true") (and (eq (include "kube-events.ingress.apiVersion" .) "networking.k8s.io/v1beta1") (semverCompare ">= 1.18-0" .Capabilities.KubeVersion.Version)) -}}
{{- end -}}
...
*/}}
{{- define "kube-events.pdb.apiVersion" -}}
